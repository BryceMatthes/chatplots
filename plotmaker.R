plotmaker <- function(user, month){
	...
	library(wordcloud)
        ...
        FreqMat <- makefreqtable(foo)
         ...
         png(paste(paste('plots/wordcloud', user, month, sep='_'),'.png',sep=''), width=1280,height=800)
         wordcloud(FreqMat$ST,FreqMat$Freq, scale=c(10,.8),min.freq=2,
        ...
        emotename <- paste(paste('plots/emotename', user, month, sep='_'),'.jpg',sep='')
        emotepername <- paste(paste('plots/emotepername', user, month, sep='_'),'.jpg',sep='')
        username <- paste(paste('plots/username', user, month, sep='_'),'.jpg',sep='')
        heatname <- paste(paste('plots/heatname', user, month, sep='_'),'.jpg',sep='')
